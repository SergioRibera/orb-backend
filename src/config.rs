...
impl Config {
    pub fn from_env() -> Self {
        Self {
            ...
            vaultara_client_id: env::var("VAULTARA_CLIENT_ID").unwrap_or_else(|_| "orb-api".to_string()),
            vaultara_client_secret: env::var("VAULTARA_CLIENT_SECRET").expect("VAULTARA_CLIENT_SECRET not set"),
            vaultara_redirect_uri: env::var("VAULTARA_REDIRECT_URI").expect("VAULTARA_REDIRECT_URI not set"),
